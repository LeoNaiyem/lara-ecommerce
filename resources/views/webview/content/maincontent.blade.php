                            ...
                            @forelse ($categories as $maincategory)
                                @if (count($maincategory->subcategories) > 0)
                                    <li class="dropdown menu-item">
                                        <a href="{{ url('products/category/' . $maincategory->slug) }}" class="dropdown-toggle"
                                            data-bs-hover="dropdown">
                                            <img src="{{ asset(Str::replaceFirst('public/', "", $maincategory->category_icon)) }}"
                                ...
                                @else
                                    <li class="dropdown menu-item">
                                        <a href="{{ url('products/category/' . $maincategory->slug) }}"
                                            class="dropdown-toggle text-truncate" data-bs-hover="dropdown">
                                            <img src="{{ asset(Str::replaceFirst('public/', "", $maincategory->category_icon)) }}"
                                                alt="{{ $maincategory->category_name }}"
                                                style="width: 22px !important;margin-top: -5px;">
                                            <span style="margin-left:6px">{{ $maincategory->category_name }}</span></a>
                    ...
                    <div class="owl-carousel owl-theme" id="slider">
                        @forelse ($sliders as $slider)
                            <div class="item" style="margin:0 !important;">
                                <img src="{{ asset(Str::replaceFirst('public/', '', $slider->slider_image)) }}"
                            ...
                            <a href="{{ url('products/category/' . $category->slug) }}">
                                <div id="cath">
                                    <div class="d-flex justify-content-center">
                                        <img src="{{ asset(Str::replaceFirst('public/', '', $category->category_icon)) }}"
                                            id="catimg">
    ...
    @if(count($featuredproducts) > 0)
        ...
        <div class="container pt-0 pb-4">
            <div class="row bg-white pb-4">
                <div class="col-12"
                    style="border-bottom: 1px solid #24a86c;padding-left: 0;display: flex;justify-content: space-between;">
                    ...
                    <a href="{{ url('featured/products') }}" class="btn btn-danger btn-sm mb-0"
                        style="padding: 2px;height: 26px;color: white;font-weight: bold;margin-top:9px;background:#24a86c;border:1px solid #24a86c">VIEW
                        ALL</a>
                </div>
                <div class="col-12">
                                                    ...
                                                    <div class="product-image" style="position: relative;">
                                                        <div class="image text-center">
                                                            <a href="{{ url('product/' . $promotional->ProductSlug) }}">
                                                                <img src="{{ asset(Str::replaceFirst('public/', "", $promotional->ViewProductImage)) }}"
                                                                    alt="{{ $promotional->ProductName }}" id="featureimagess"
                                                                    style="height: 175px">
                                                            </a>
                                                        </div>
                                                        <span id="discountpart"> <span id="discountparttwo">
                                                                <p id="pdis">-{{ $promotional->Discount }}%</p>
                                                            </span></span>
                                                    </div>
                                                    <!-- /.product-image -->
                                                </div>
                    ...
                    <div class="col-lg-6 col-6 ps-0">
                        <div class="media-banner mb-1 mb-lg-0">
                            <a href="{{ $add->add_link }}" target="_blank" class="banner-container">
                                <img src="{{ asset(Str::replaceFirst('public/', '', $add->add_image)) }}" alt="{{ env('APP_NAME') }}"
            ...
            <div class="container pt-0 pb-4">
                <div class="row bg-white pb-0">
                    <div class="col-12"
                        ...
                        <a href="{{url('products/category/' . $categoryproduct->slug)}}" class="btn btn-danger btn-sm mb-0"
                            style="padding: 2px;height: 26px;color: white;font-weight: bold;margin-top:9px;background: #24a86c;border: 1px solid #24a86c;">VIEW
                            ALL</a>
                    </div>
                                ...
                                <div class="product-micro">
                                    <div class="row product-micro-row">
                                            ...
                                            <div class="product-image" style="position: relative;">
                                                <div class="image text-center">
                                                    <a href="{{ url('product/' . $product->ProductSlug) }}">
                                                        <img src="{{ asset(Str::replaceFirst('public/', '', $product->ViewProductImage)) }}"
                                                            alt="{{ $product->ProductName }}" id="featureimage">
                                                    </a>
                                                </div>
                                                <span id="discountpart"> <span id="discountparttwo">
                                                        <p id="pdis">-{{ $product->Discount }}%</p>
                                                    </span></span>
                                                <!-- /.image -->
                                            </div>
                                            <!-- /.product-image -->
                                        ...
                                        <div class="col-12">
                                            ...
                                            <form name="form" action="{{url('add-to-cart')}}" method="POST"
                                                enctype="multipart/form-data" style="width: 100%;float: left;text-align: center;">
                                                @method('POST')
                                                @csrf
                                                <input type="text" name="color" id="product_colorold" hidden>
                                                <input type="text" name="size" id="product_sizeold" hidden>
